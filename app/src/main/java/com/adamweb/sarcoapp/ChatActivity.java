...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lists.add(new ChatList("Zahraddin Yusif", "9:35 AM", "yaushe zamu shiga", R.drawable.zdeen));
        ...
        lists.add(new ChatList("Nura Ahmad Sulaiman", "7:15 PM", "m nura ya kasuwa", R.drawable.user_profile_dp));
